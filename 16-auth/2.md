...
- Use the starter code found in this repo
...
Using the starter code, create a controller `pages` with three different methods "everyone", "logged_in" and "logged_out".
